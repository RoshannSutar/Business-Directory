    ...
    >
      ...
      <View style={{ marginLeft: 10, flex: 1 }}>
        ...
        <View style={{ display:'flex',flexDirection: 'row', alignItems: 'center', marginTop: 7 , gap:15}}>
          ...
          <View style={{ padding: 2, backgroundColor: '#d3e4e0', borderRadius: 5, borderColor: Colors.PRIMARY, borderWidth: 0.5 }}>
            <Text style={{ fontFamily: 'archivo', fontSize: 13, color: Colors.PRIMARY, }}>{business.category}</Text>
          </View>
        </View>
      </View>
    </TouchableOpacity>
